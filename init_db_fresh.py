"""
Drop all tables from the database pointed to by DATABASE_URL, then recreate the
schema and seed the default admin/settings rows.
...
with app.app_context():
    ...
    print(f"[INFO] 清空并重建数据库: {describe_database(db_uri)}")
